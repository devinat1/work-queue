  ...
  return (
    <form onSubmit={handleSubmit} className="flex flex-col gap-2">
      ...
      <textarea
        ...
        className="px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent placeholder:text-gray-400 text-gray-900 resize-none"
        disabled={isLoading}
        rows={2}
      />
    </form>
